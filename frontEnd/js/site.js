$(document).ready(function () {
    ...
    $( '.regForm' ).on( 'submit', function( event ) {
        ...
        let bkash= formData[4]['value'];
        let trxID= formData[5]['value'];
        ...
        if(mobile.length!=11){
            ...
            myToast('Please Enter 11 Digit Bkash Number');
        }
        else if(trxID.length!=10){
            myToast('Bkash Wrong Trx Id !');
        }
        else{
            ...
            axios.post(URL,
                ...
                .then(function (response) {
                    ...
                    else if(response.data=="TrxExist"){
                        $( ".regBtn" ).html("Submit")
                        myToast("Bkash Trx Already Used");
                    }
